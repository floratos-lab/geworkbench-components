 ...
 * @version 1.0
 */
public class SingleSequenceViewPanel extends JPanel {
    ...
    public boolean isSingleSequenceView() {
    ...
    public void setSequenceDB(DSSequenceSet sequenceDB) {
...
//changed for the simplifed use,should replace the above method.
    ...
    private void drawPattern(Graphics g, DSSequence hitSeq, int offset,
        ...
        if (offset % cols + length <= cols) {
            ...
            g.setColor(org.geworkbench.components.sequenceretriever.SingleSequenceViewPanel.DRECTIONCOLOR);
