...
public class SkyBaseConfigPanel extends AbstractSaveableParameterPanel implements Serializable
{
	...
	{
	    this.mincov = mincov; this.minsid = minsid; this.rphits = rphits;
	}
	...
	return new SerializedInstance((Integer)mincovEdit.getValue(), (Integer)minsidEdit.getValue(), (Integer)rphitsEdit.getValue());
    }
