 ...
 * 
 * @author keshav
 * @version $Id: PollingThread.java,v 1.1 2008-12-09 16:57:04 wangm Exp $
 */
	...
	public void run() {
		...
		try {
			...
			if (result instanceof Exception){
				//generate user understandable messages. Detailed information will shown on dispatcher server's log.debug
				String errorMessage = "";
			...
			JOptionPane.showMessageDialog(null, "Cannot connect to cagrid server", "Cagrid Connection Failure", JOptionPane.ERROR_MESSAGE);
