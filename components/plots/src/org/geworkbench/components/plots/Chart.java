...
/** Individual chart in the scatter plot. */
class Chart {
	int index; // index of the data point in the entire dataset (marker or microarray)
    ChartPanel panel; // JFreeChart panel
    ...
    public Chart(DSMicroarraySetView<DSGeneMarker, DSMicroarray> dataSetView) {
