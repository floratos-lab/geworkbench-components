 ...
 * Schema.
 * $Id: PdbidsDescriptor.java,v 1.1 2009-01-19 02:28:35 wangm Exp $
 */
 ...
 */
public class PdbidsDescriptor extends jalview.schemabinding.version2.PdbentryDescriptor {
    ...
    public PdbidsDescriptor() {
        super();
        setExtendsWithoutFlatten(new jalview.schemabinding.version2.PdbentryDescriptor());
    ...
    } //-- jalview.schemabinding.version2.PdbidsDescriptor()
