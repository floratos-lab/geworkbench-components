 ...
 * Schema.
 * $Id: JalviewUserColoursDescriptor.java,v 1.1 2008-02-19 16:22:47 wangm Exp $
 */
...
public class JalviewUserColoursDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public JalviewUserColoursDescriptor() {
        super();
        nsURI = "www.jalview.org/colours";
        xmlName = "JalviewUserColours";
        ...
        //-- _colourList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(jalview.schemabinding.version2.Colour.class, "_colourList", "colour", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    JalviewUserColours target = (JalviewUserColours) object;
                    target.addColour( (jalview.schemabinding.version2.Colour) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new jalview.schemabinding.version2.Colour();
            }
        } );
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
    } //-- jalview.schemabinding.version2.JalviewUserColoursDescriptor()
