 ...
 *          keshav Exp $
 */
public class DiscreteHitOrMissHeatMapPanel extends JPanel implements MouseListener, MouseMotionListener {
    ...
    */
    public void paintComponent(Graphics g) {
        ...
        int x = 15, y = 120;
        for (SerializedRule srule : srules) {
            Rectangle2D.Double rect = new Rectangle2D.Double(x, y, 15, 15*targetNames.size());
            x += 15;
     ...
     */
    private void drawColumnNames(SerializedRule srule, Graphics2D g2d, int row, int lcol) {
        ...
        Rectangle2D.Double rect = new Rectangle2D.Double(lcol - stringBound.getHeight(),
                                                        row - stringBound.getWidth(),
                                                        stringBound.getHeight(),
                                                        stringBound.getWidth());
        rectRule.add(new RectangleRule(rect, srule));
    }
    ...
    public void mouseMoved(MouseEvent e) {
        ...
        for(Iterator itr=rectRule.iterator();itr.hasNext();){
            ...
            if(rectangleRule.rect.contains(e.getX(),e.getY())){
                check =true;
                break;
                // uncomment following, if border of the rectangle needs to be shown on mouse-hover
                /*this.repaint();
    ...
    public void mouseClicked(MouseEvent e) {
        System.out.println("In HitOrMissHeatPanel: MOUSE CLICKED. MOUSE CLICKED. RUN RUN !!");
        ...
        for(Iterator itr=rectRule.iterator();itr.hasNext();){
            ...
            if(rectangleRule.rect.contains(e.getX(),e.getY())){
                ...
                System.out.println("Inside : "+MedusaUtil.generateConsensusSequence(rectangleRule.rule
                .getPssm()));
    ...
    private void addTab(SerializedRule rule) {
        ...
        scrollPane.setPreferredSize(new Dimension(psamImage.getIconWidth(), 190));
        ...
        mainScrollPane.setPreferredSize(new Dimension((int)psamImage.getIconWidth()+10, (int)parentPanel.getPreferredSize().getHeight()-30));
        builder.getPanel().setPreferredSize(new Dimension((int)mainScrollPane.getPreferredSize().getWidth()+10, (int)mainScrollPane.getPreferredSize().getHeight()+10));
