/**
 * HierarchicalClusteringResourceProperties.java
 *
...
public class HierarchicalClusteringResourceProperties  implements java.io.Serializable {
    private gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata;

    public HierarchicalClusteringResourceProperties() {
    }
    ...
    /**
     * Gets the serviceMetadata value for this HierarchicalClusteringResourceProperties.
     * 
    ...
    /**
     * Sets the serviceMetadata value for this HierarchicalClusteringResourceProperties.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HierarchicalClusteringResourceProperties)) return false;
        HierarchicalClusteringResourceProperties other = (HierarchicalClusteringResourceProperties) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HierarchicalClusteringResourceProperties.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://cagrid.geworkbench.columbia.edu/HierarchicalClustering", ">HierarchicalClusteringResourceProperties"));
