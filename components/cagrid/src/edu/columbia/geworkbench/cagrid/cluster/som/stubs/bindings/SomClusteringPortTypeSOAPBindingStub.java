/**
 * SomClusteringPortTypeSOAPBindingStub.java
 *
 * This file was auto-generated from WSDL
 * by the Apache Axis 1.2RC2 Mar 03, 2006 (12:17:06 EST) WSDL2Java emitter.
 */

package edu.columbia.geworkbench.cagrid.cluster.som.stubs.bindings;

public class SomClusteringPortTypeSOAPBindingStub extends org.apache.axis.client.Stub implements edu.columbia.geworkbench.cagrid.cluster.som.stubs.SomClusteringPortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(new javax.xml.namespace.QName("http://cagrid.geworkbench.columbia.edu/SomClustering", "ExecuteRequest"), new javax.xml.namespace.QName("http://cagrid.geworkbench.columbia.edu/SomClustering", ">ExecuteRequest"), edu.columbia.geworkbench.cagrid.cluster.som.stubs.ExecuteRequest.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.setReturnType(new javax.xml.namespace.QName("http://cagrid.geworkbench.columbia.edu/SomClustering", ">ExecuteResponse"));
        oper.setReturnClass(edu.columbia.geworkbench.cagrid.cluster.som.stubs.ExecuteResponse.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://cagrid.geworkbench.columbia.edu/SomClustering", "ExecuteResponse"));
    ...
    public SomClusteringPortTypeSOAPBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public SomClusteringPortTypeSOAPBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public SomClusteringPortTypeSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    private void addBindings0() {
            ...
            qName = new javax.xml.namespace.QName("http://cagrid.geworkbench.columbia.edu/SomClustering", ">>ExecuteRequest>somClusteringParameter");
            cachedSerQNames.add(qName);
            cls = edu.columbia.geworkbench.cagrid.cluster.som.stubs.ExecuteRequestSomClusteringParameter.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://cagrid.geworkbench.columbia.edu/SomClustering", ">SomClusteringResourceProperties");
            cachedSerQNames.add(qName);
            cls = edu.columbia.geworkbench.cagrid.cluster.som.stubs.SomClusteringResourceProperties.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://cagrid.geworkbench.columbia.edu/SomClustering", ">ExecuteRequest");
            cachedSerQNames.add(qName);
            cls = edu.columbia.geworkbench.cagrid.cluster.som.stubs.ExecuteRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("gme://cagrid.geworkbench.columbia.edu/1/edu.columbia.geworkbench.cagrid.cluster.som", "SomCluster");
            cachedSerQNames.add(qName);
            cls = edu.columbia.geworkbench.cagrid.cluster.som.SomCluster.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("gme://cagrid.geworkbench.columbia.edu/1/edu.columbia.geworkbench.cagrid.cluster.som", "SomClusteringParameter");
            cachedSerQNames.add(qName);
            cls = edu.columbia.geworkbench.cagrid.cluster.som.SomClusteringParameter.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://cagrid.geworkbench.columbia.edu/SomClustering", ">ExecuteResponse");
            cachedSerQNames.add(qName);
            cls = edu.columbia.geworkbench.cagrid.cluster.som.stubs.ExecuteResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("gme://cagrid.geworkbench.columbia.edu/1/edu.columbia.geworkbench.cagrid.microarray", "Marker");
            cachedSerQNames.add(qName);
            cls = edu.columbia.geworkbench.cagrid.microarray.Marker.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://cagrid.geworkbench.columbia.edu/SomClustering", ">>ExecuteRequest>microarraySet");
            cachedSerQNames.add(qName);
            cls = edu.columbia.geworkbench.cagrid.cluster.som.stubs.ExecuteRequestMicroarraySet.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    private void addBindings1() {
            ...
            java.lang.Class simplelistsf = org.apache.axis.encoding.ser.SimpleListSerializerFactory.class;
            java.lang.Class simplelistdf = org.apache.axis.encoding.ser.SimpleListDeserializerFactory.class;
            qName = new javax.xml.namespace.QName("gme://cagrid.geworkbench.columbia.edu/1/edu.columbia.geworkbench.cagrid.microarray", "Microarray");
            cachedSerQNames.add(qName);
            cls = edu.columbia.geworkbench.cagrid.microarray.Microarray.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("gme://cagrid.geworkbench.columbia.edu/1/edu.columbia.geworkbench.cagrid.microarray", "MicroarraySet");
            cachedSerQNames.add(qName);
            cls = edu.columbia.geworkbench.cagrid.microarray.MicroarraySet.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public edu.columbia.geworkbench.cagrid.cluster.som.stubs.ExecuteResponse execute(edu.columbia.geworkbench.cagrid.cluster.som.stubs.ExecuteRequest parameters) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setSOAPActionURI("http://cagrid.geworkbench.columbia.edu/SomClustering/ExecuteRequest");
        _call.setEncodingStyle(null);
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (edu.columbia.geworkbench.cagrid.cluster.som.stubs.ExecuteResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (edu.columbia.geworkbench.cagrid.cluster.som.stubs.ExecuteResponse) org.apache.axis.utils.JavaUtils.convert(_resp, edu.columbia.geworkbench.cagrid.cluster.som.stubs.ExecuteResponse.class);
            }
        }
    }
