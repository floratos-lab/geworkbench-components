...
public class HierarchicalClusteringClient extends ServiceSecurityClient implements HierarchicalClusteringI {
    ...
    public HierarchicalClusteringClient( String url ) throws MalformedURIException, RemoteException {
        this( url, null );
    }

    public HierarchicalClusteringClient( String url, GlobusCredential proxy ) throws MalformedURIException,
            RemoteException {
        super( url, proxy );
        initialize();
    }

    public HierarchicalClusteringClient( EndpointReferenceType epr ) throws MalformedURIException, RemoteException {
        this( epr, null );
    }

    public HierarchicalClusteringClient( EndpointReferenceType epr, GlobusCredential proxy )
    ...
    private HierarchicalClusteringPortType createPortType() throws RemoteException {
        ...
        try {
            port = locator.getHierarchicalClusteringPortTypePort( getEndpointReference() );
        } catch ( Exception e ) {
    ...
    public static void usage() {
        System.out.println( HierarchicalClusteringClient.class.getName() + " -url <service url>" );
    }
        ...
        try {
            ...
            if ( !( args.length < 3 ) ) {// keshav
                if ( args[0].equals( "-url" ) ) {
                    ...
                    parameters.setDistance( "Euclidean" );
                    parameters.setMethod( "complete" );
                    HierarchicalCluster hierarchicalClustering = client.execute( arraySet, parameters );
