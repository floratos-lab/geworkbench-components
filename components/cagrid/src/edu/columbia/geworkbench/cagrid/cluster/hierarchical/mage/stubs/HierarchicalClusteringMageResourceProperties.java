/**
 * HierarchicalClusteringMageResourceProperties.java
 *
...
public class HierarchicalClusteringMageResourceProperties  implements java.io.Serializable {
    private gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata;

    public HierarchicalClusteringMageResourceProperties() {
    }
    ...
    /**
     * Gets the serviceMetadata value for this HierarchicalClusteringMageResourceProperties.
     * 
    ...
    /**
     * Sets the serviceMetadata value for this HierarchicalClusteringMageResourceProperties.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HierarchicalClusteringMageResourceProperties)) return false;
        HierarchicalClusteringMageResourceProperties other = (HierarchicalClusteringMageResourceProperties) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HierarchicalClusteringMageResourceProperties.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://cagrid.geworkbench.columbia.edu/HierarchicalClusteringMage", ">HierarchicalClusteringMageResourceProperties"));
