...
/**
 * This class is autogenerated, DO NOT EDIT. This class is not thread safe. A new instance should be created for any
 * threads using this class. On construction the class instance will contact the remote service and retrieve it's
...
public class SomClusteringClient extends ServiceSecurityClient implements SomClusteringI {
    ...
    public SomClusteringClient( String url ) throws MalformedURIException, RemoteException {
        this( url, null );
    }

    public SomClusteringClient( String url, GlobusCredential proxy ) throws MalformedURIException, RemoteException {
        super( url, proxy );
        initialize();
    }

    public SomClusteringClient( EndpointReferenceType epr ) throws MalformedURIException, RemoteException {
        this( epr, null );
    }

    public SomClusteringClient( EndpointReferenceType epr, GlobusCredential proxy ) throws MalformedURIException,
            RemoteException {
        super( epr, proxy );
        initialize();
    }
    ...
    public static void usage() {
        System.out.println( SomClusteringClient.class.getName() + " -url <service url>" );
    }
        ...
        try {
            ...
            if ( !( args.length < 3 ) ) {// keshav
                if ( args[0].equals( "-url" ) ) {
                    ...
                    log.debug( "Invoking Self Organized Maps Clustering Service ... " );
                    ...
                    SomCluster somCluster = client.execute( arraySet, somParameter );
                    for ( int i = 0; i < somCluster.getXCoordinate().length; i++ ) {
                        log.debug( "name at " + i + ":" + somCluster.getName()[i] );
                        log.debug( "x coordinate at " + i + ":" + somCluster.getXCoordinate()[i] );
                        log.debug( "y coordinate at " + i + ":" + somCluster.getYCoordinate()[i] + "\n" );
                    }
                } else {
                    usage();
                    System.exit( 1 );
    ...
    public edu.columbia.geworkbench.cagrid.cluster.som.SomCluster execute(edu.columbia.geworkbench.cagrid.microarray.MicroarraySet microarraySet,edu.columbia.geworkbench.cagrid.cluster.som.SomClusteringParameter somClusteringParameter) throws RemoteException {
      synchronized(portTypeMutex){
        ...
        somClusteringParameterContainer.setSomClusteringParameter(somClusteringParameter);
        params.setSomClusteringParameter(somClusteringParameterContainer);
        edu.columbia.geworkbench.cagrid.cluster.som.stubs.ExecuteResponse boxedResult = portType.execute(params);
