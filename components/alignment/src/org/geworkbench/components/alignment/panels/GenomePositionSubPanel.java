...
public class GenomePositionSubPanel
    ...
    void jbInit() throws Exception {
        ...
        SourceBox.addItem("human (GoldenPath)");
        SourceBox.addItem("mouse (GoldenPath)");
        SourceBox.addItem("rat (GoldenPath)");
        SourceBox.addItem("chimpanzee (GoldenPath)");
        SourceBox.addActionListener(new
                                     GenomePosSubPanel_sourceBox_actionAdapter(this));
        initSourceSelection("hg16", ChrBox);
