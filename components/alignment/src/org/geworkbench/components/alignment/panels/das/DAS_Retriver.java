package org.geworkbench.components.alignment.panels.das;
...
public class DAS_Retriver {
    ...
    public static void getHumanAnnotation(String chr, int from, int to, String fil) {
        /* Forming request */
        String request = "http://genome.cse.ucsc.edu/cgi-bin/das/hg16/features?segment=";
    ...
    public static void getGPAnnotation(String genome, String chr, int from, int to, String feat, String fil) {
        /* Forming request */
    ...
    public static void getHumanSequence(String chr, int from, int to, String fil) {

        /* Forming request */
        String request = "http://genome.cse.ucsc.edu/cgi-bin/das/hg16/dna?segment=";
    ...
    public static void getGpSequence(String genome, String chr, int from, int to, String fil) {
