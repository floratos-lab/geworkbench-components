...
public class AlignmentTreePanel extends JPanel implements TreeSelectionListener {
    private BlastViewPanel htmlPane;
    private JTree tree;
    private URL helpURL;
    ...
    public void jbInit() {
        ...
        //Create the nodes.
        DefaultMutableTreeNode top = new DefaultMutableTreeNode("Sequence File Name");
        createNodes(top);
    ...
    private class SequenceAlignmentPairInfo {
        public String sequenceName;
        public Vector hits;

        public SequenceAlignmentPairInfo(String seq, Vector theHits) {
            hits = theHits;
            sequenceName = seq;
        }
    ...
    private class BookInfo {
        ...
        public BookInfo(String book, String filename) {
            bookName = book;
            bookURL = AlignmentTreePanel.class.getResource(filename);
            if (bookURL == null) {
    ...
    private void initHelp() {
        ...
        helpURL = AlignmentTreePanel.class.getResource(s);
        if (helpURL == null) {
    ...
    private void createNodes(DefaultMutableTreeNode top) {
        ...
        category = new DefaultMutableTreeNode("Sequence 1");
        top.add(category);

        //original Tutorial
        book = new DefaultMutableTreeNode(new BookInfo("seq2", "tutorial.html"));
        category.add(book);
    ...
    private static void createAndShowGUI() {
        ...
        AlignmentTreePanel newContentPane = new AlignmentTreePanel();
