...
/**
 * BlastObj.java
 * A class to hold information about each individual hit of a Blast database search on a protein sequence.
 * <br>
 * Currently this class can only be instantiated by the <code> BlastParser </code> class.
 */
public class BlastObj {
    ...
    String description;
    /**
     * The percentage of the query that's aligned with protein sequence hit in this BlastObj.
     */
    int percentAligned;

    /**
     * The percentage of the alignment of query and hit in this BlastObj that's gapped.
     */
    int percentGapped = 0;

    /**
     * The percentage of the alignment of query and hit in this BlastObj that's "positive"/conserved.
     */
    int percentPos;

    /**
     * The score of the alignment of query and hit in this BlastObj; initialized to -1.
     */
    int score = -1;
    ...
    /**
     * The 2 element array containing the position in query sequence where the alignment start and stop.
     * change to public for temp.
     *
    ...
    String query;
    /**
     * The String of hit sequence in this BlastObj in alignment with query sequence.
     */
    String subject;
    /**
     * The String of alignment sequence between query sequence and hit in this BlastObj.
     */
    String align;
    /**
    ...
    /**
     * Returns the length of the alignment of query and hit seq stored in this BlastObj.
     *
    ...
    /**
     * Returns the percentage of the alignment that's gapped with protein sequence hit in this BlastObj.
     *
    ...
    /**
     * Returns the percentage of the query that's conserved with protein sequence hit in this BlastObj.
     *
    ...
    /**
     * Returns the score of the alignment of query and protein sequence hit in this BlastObj.
     *
    ...
    /**
     * Returns the query in alignment with protein sequence hit in this BlastObj.
     *
    ...
    /**
     * Returns the protein sequence hit in this BlastObj in alignment with the query.
     *
     ...
     * BlastObj.
     *
     * @param		s, the new database name of this BlastObj.
     */
     ...
     * BlastObj.
     *
     * @param		s, the new accession number of this BlastObj.
     */

    /**
     * Sets the description of the hit protein sequence stored in this BlastObj.
     *
     * @param		s, the new description of this BlastObj.
     */
    ...
    /**
     * Sets the length of the alignment of query and hit protein sequence stored in this
     * BlastObj.
     *
     * @param		i, the alignment length of this BlastObj.
     */

    /**
     * Sets the percentage of the query that's aligned with protein sequence hit in this BlastObj.
     *
     * @param		i, the new alignment percentage of this BlastObj.
     */
    ...
    /**
     * Sets the percentage of the alignment that's gapped of query and hit protein sequence
     * hit in this BlastObj.
     *
     * @param		i, the new gapped percentage of this BlastObj.
     */
    ...
    /**
     * Sets the percentage of the query that's conserved with protein sequence hit in this BlastObj.
     *
     * @param		i, the new conserved percentage of this BlastObj.
     */
    ...
    /**
     * Sets the score of the alignment of the query with protein sequence hit in this BlastObj.
     *
     * @param		i, the new score of this BlastObj.
     */
    ...
    /**
     * Sets the e-value of the alignment of the query with protein sequence hit in this BlastObj.
     *
     * @param		s, the new e-value of this BlastObj.
     */
    ...
    /**
     * Sets the query sequence of the alignment with protein sequence hit in this BlastObj.
     *
     * @param		s, the new query seq of this BlastObj.
     */
     ...
     *
     * @param		s, the new subject seq of this BlastObj.
     */
    ...
    /**
     * Sets the alignment sequence of the query with protein sequence hit in this BlastObj.
     *
     * @param		s, the new align seq of this BlastObj.
     */
     ...
     *
     * @param		b, the new include Boolean of this BlastObj.
     */
