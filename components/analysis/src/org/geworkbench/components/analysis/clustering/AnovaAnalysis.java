...
//                        System.out.println(labelA+Integer.toString(i)+","+Integer.toString(k)+"+"+Integer.toString(aIndex));
	        ...
	        try{
	            ...
	            anovaResult.setAllMeans(new float[pFM.getRowDimension()*mFM.getColumnDimension()]);
	            anovaResult.setAllStds(new float[pFM.getRowDimension()*mFM.getColumnDimension()]);
	            anovaResult.setPVals(new float[pFM.getRowDimension()]);
	            anovaResult.setAdjPVals(new float[pFM.getRowDimension()]);
	            anovaResult.setFVals(new float[pFM.getRowDimension()]);
	            ...
	            for (int i = 0; i < pFM.getRowDimension(); i++) {
	            	if (pFM.A[i][0]<pvalueth){
	            		...
	            		anovaResult.setPVals(i, pFM.A[i][0]);
	            		anovaResult.setAdjPVals(i, apFM.A[i][0]);
	            		anovaResult.setFVals(i, fFM.A[i][0]);
...
//	            		System.out.print("±"+new Float(sFM.A[i][j]));
	            		anovaResult.setAllMeans(j*pFM.getRowDimension()+i, mFM.A[i][j]);
	            		anovaResult.setAllStds(j*pFM.getRowDimension()+i, sFM.A[i][j]);
	            	}
//	            	System.out.println();
	            }
