...
public class AracneResourceProperties  implements java.io.Serializable {
    private gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata;

    public AracneResourceProperties() {
    }
    ...
    /**
     * Gets the serviceMetadata value for this AracneResourceProperties.
     * 
    ...
    /**
     * Sets the serviceMetadata value for this AracneResourceProperties.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AracneResourceProperties)) return false;
        AracneResourceProperties other = (AracneResourceProperties) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AracneResourceProperties.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://cagrid.geworkbench.columbia.edu/Aracne", ">AracneResourceProperties"));
