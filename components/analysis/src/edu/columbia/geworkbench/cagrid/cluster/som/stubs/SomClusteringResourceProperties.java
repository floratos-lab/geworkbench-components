/**
 * SomClusteringResourceProperties.java
 *
...
public class SomClusteringResourceProperties  implements java.io.Serializable {
    private gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata;

    public SomClusteringResourceProperties() {
    }
    ...
    /**
     * Gets the serviceMetadata value for this SomClusteringResourceProperties.
     * 
    ...
    /**
     * Sets the serviceMetadata value for this SomClusteringResourceProperties.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SomClusteringResourceProperties)) return false;
        SomClusteringResourceProperties other = (SomClusteringResourceProperties) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SomClusteringResourceProperties.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://cagrid.geworkbench.columbia.edu/SomClustering", ">SomClusteringResourceProperties"));
