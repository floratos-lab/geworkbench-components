 ...
 * @author keshav
 * @version $Id: ApplicationServiceClientImpl.java,v 1.1 2007-01-22 20:06:35 keshav Exp $
 *
 */
public class ApplicationServiceClientImpl extends ApplicationService
{
	...
	public ApplicationServiceClientImpl()
	{
		...
		try
		{
			...
			_properties.load(loader.getResourceAsStream("CORESystem.properties"));
	...
	@Override
	public List evsSearch(EVSQuery arg0) throws ApplicationException
	{
