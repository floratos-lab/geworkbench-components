 ...
 * @version 1.0
 */
public class PatternDiscoveryHierachicalNode {

    public CSMatchedSeqPattern pattern;
    public CSMatchedHMMOriginSeqPattern hmmPattern;
    public int patIncluded;
    public int patExcluded;
    public int hPatIncluded;
    public int hPatExcluded;

    public PatternDiscoveryHierachicalNode(CSMatchedSeqPattern _pattern) {
        //default pattern.
        pattern = _pattern;
