...
public class ParameterPanel extends JPanel {
    ...
    void jbInit() throws Exception {
        //Basic Panel
        titledBorder1 = new TitledBorder(new EtchedBorder(EtchedBorder.RAISED, Color.white, new Color(148, 145, 140)), "As percent of sequences");
        ...
        jConsRegionExtBox.addActionListener(new ParameterPanel_jConsRegionExtBox_actionAdapter(this));
        jEntThreshBox.setEnabled(true);
        jEntThreshBox.setSelectionEnd(0);
        jEntThreshBox.setSelectionStart(0);
        jEntThreshBox.setText("16");
        jEntThreshBox.addActionListener(new ParameterPanel_jEntThreshBox_actionAdapter(this));
        ...
        //input verifier
        jGroupSizeBox.setInputVerifier(new RegularExpressionVerifier("(\\d){1,9}"));
        //Limits Panel
        ...
        //input verifier
        jMaxPatternNoBox.setInputVerifier(new RegularExpressionVerifier("(\\d){1,9}"));
        jMaxRunTimeBox.setInputVerifier(new RegularExpressionVerifier("(\\d){1,9}"));
        //Exhaustive Panel
        ...
        jMinClusterSizeBox.setInputVerifier(new RegularExpressionVerifier("(\\d){1,9}"));
        ...
        jDecreaseSupportBox.addActionListener(new ParameterPanel_jDecreaseSupportBox_actionAdapter(this));
        //input verifier
        jDecreaseSupportBox.setInputVerifier(new RegularExpressionVerifier("(\\d){1,9}(%)?"));
        //Hierarchical Panel
        jHierarchicalPane.setLayout(gridBagLayout3);
        jHierarchicalPane.add(jMinClusterSizeLabel, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
        jHierarchicalPane.add(jMinClusterSizeBox, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
        jHierarchicalPane.add(jMinPatternNoLabel, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
        jHierarchicalPane.add(jMinPatternNoBox, new GridBagConstraints(1, 1, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
        jMinPatternNoLabel.setText("Min. Pattern Number:");
        jMinPatternNoBox.setText("10");
        jMinClusterSizeLabel.setText("Min. Cluster Size:");

        jMinPatternNoBox.setInputVerifier(new RegularExpressionVerifier("(\\d){1,9}"));
        ...
        BasicPane.add(jMinWTokensLabel, new GridBagConstraints(0, 3, 1, 1, 0.0, 1.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
        ...
        jGroupingPane.add(jGroupsBox, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(2, 4, 2, 4), 139, 0));
        jGroupingPane.add(jGroupSizeBox, new GridBagConstraints(1, 1, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(2, 4, 2, 4), 0, 0));
        jGroupingPane.add(jGroupSizeLabel, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
        jGroupingPane.add(jGroupsLabel, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));

        jLimitsPane.add(jMaxPatternNoLabel, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
        jLimitsPane.add(jMaxRunTimeLabel, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
        jLimitsPane.add(jMaxRunTimeBox, new GridBagConstraints(1, 1, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(2, 4, 2, 4), 0, 0));
        jLimitsPane.add(jMaxPatternNoBox, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(2, 4, 2, 4), 0, 0));

        jPanel1.add(jDecreaseSupportLabel, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 2), 0, 0));
        jPanel1.add(jDecreaseSupportBox, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 2, 0, 2), 0, 0));
        jPanel1.add(jLabel3, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 2, 0, 2), 0, 0));
        jPanel1.add(jMinSupportExhaustive, new GridBagConstraints(3, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 2, 0, 0), 0, 0));
        jExhaustivePane.add(jPanel2, new GridBagConstraints(0, 1, 2, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

        jPanel2.add(jDecreaseDensitySupportLabel, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
        jPanel2.add(jDecreaseDensitySupportBox, new GridBagConstraints(1, 0, 1, 1, 0.5, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
        jPanel2.add(jLabel4, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
        jPanel2.add(jTextField1, new GridBagConstraints(3, 0, 1, 1, 0.5, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
        jExhaustivePane.add(jSequenceRadioButton, new GridBagConstraints(1, 3, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
        jExhaustivePane.add(jLabel1, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
        jExhaustivePane.add(jLabel2, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 0, 2), 0, 0));
        jExhaustivePane.add(jOccurenceRadioButton, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
        jExhaustivePane.add(jPanel1, new GridBagConstraints(0, 0, 2, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

        jProfileHMMPane.add(jEntThreshBox, new GridBagConstraints(1, 1, 2, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 2, 0, 0), 0, 0));
        jProfileHMMPane.add(jConsRegionExtLabel, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
        jProfileHMMPane.add(jConsRegionExtBox, new GridBagConstraints(1, 2, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 2, 0, 0), 0, 0));
        jProfileHMMPane.add(jSlidingWindowBox, new GridBagConstraints(1, 3, 2, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 2, 0, 0), 0, 0));
        jProfileHMMPane.add(jSlidWindowSizeLabel, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
        jProfileHMMPane.add(jEntThreshLabel, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
        jProfileHMMPane.add(jUseHMMBox, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    ...
    public String getDensityConstraint() {
        String decConstraint = (String) jDecreaseDensitySupportBox.getSelectedItem();
...
class ParameterPanel_jDecreaseSupportBox_actionAdapter implements java.awt.event.ActionListener {
...
class ParameterPanel_jEntThreshBox_actionAdapter implements java.awt.event.ActionListener {
    ParameterPanel adaptee;
