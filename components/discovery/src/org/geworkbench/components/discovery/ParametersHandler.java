...
/**
 * <p>Title: ParametersHandler</p>
 * <p>Description: Written to separate parameters view from parameters data
 * handling </p>
 * <p>Copyright: Copyright (c) 2003</p>
 * <p>Company: CalifanoLab </p>
 *
...
public class ParametersHandler {
     ...
     *
     * @param parmsPanel ParameterPanel
     * @param seqNo      int
     * @param command    String
     * @return Parameters the parameters from the panel
     */
    public Parameters readParameter(ParameterPanel parmsPanel, int seqNo, String command) {
        ...
        try {
            ...
            if (supportString.endsWith("%")) {
                ...
                parms.setMinPer100Support(Double.parseDouble(supportString.replace('%', ' ')) / 100.0);
                parms.setMinSupport((int) (Math.ceil(parms.getMinPer100Support() * (double) seqNo)));
                parms.setCountSeq(1);
            } else {
            ...
            if (command.equalsIgnoreCase("Exhaustive")) {
                ...
                if (minSupportStr.endsWith("%")) {
                    ...
                    if (percent > 0.0 && percent < 1.0) {
                        minSupport = (int) (percent * (double) parms.getMinSupport());
                    }
                } else {
